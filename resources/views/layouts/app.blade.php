<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" dir="{{ app()->getLocale() === 'fa' ? 'rtl' : 'ltr' }}" id="htmlElement" data-input-language="english" style="font-family: 'Vazirmatn', Tahoma, Arial, sans-serif;">
    <head>
        <meta charset="utf-8">
